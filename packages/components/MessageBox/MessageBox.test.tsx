...
describe('MessageBox Component', () => {
	it('renders correctly', async () => {
		...
		MessageBox(props)
		await rAF()
		const header = document.querySelector('.vr-message-box__header')
		const title = document.querySelector('.vr-message-box__title')
		const message = document.querySelector('.vr-message-box__message')
