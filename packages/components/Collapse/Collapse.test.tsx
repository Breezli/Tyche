...
describe('Collapse.vue', () => {
	beforeAll(() => {
		...
		headers = wrapper.findAll('.vr-collapse-item__header')
		contents = wrapper.findAll('.vr-collapse-item__wapper')
	...
	test('手风琴模式 错误处理', () => {
        ...
        [
          [
            [VrUIError: [VrCollapse] accordion mode should only have one active item],
          ],
        ]
      `
		)
